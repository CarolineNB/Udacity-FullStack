...
# #             raise AuthError('Authorization header is malformeds', 401)
...
#         raise AuthError('Permission is not valid', 400)
    
#     if permission not in payload['permissions']:
#         raise AuthError('Permission not authorized', 401)
...
#     raise AuthError('Unable to find key', 401)
